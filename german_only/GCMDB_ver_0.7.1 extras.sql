...
# Copyright (C) 2017 GCMDB <https://github.com/Xadras/GCMDB> 				#
#									   		 								#
...
UPDATE `areatrigger_teleport` SET `name`='Höhlen der Zeit, Der schwarze Morast - Eingang', `status_failed_text`='Ihr könnt den schwarzen Morast nicht betreten bis Ihr Thrall aus der Burg Durnholde gerettet habt.' WHERE (`id`='4320');
